...
//
node * my_copy_0_1 = array_ptrs_to_each_element_in_linked_list(linked_list_0, 0);
int x_0 = print_jumper_pts_to_value(my_copy_0_1, 0);
//
...
//
node * my_copy_1_1 = array_ptrs_to_each_element_in_linked_list(linked_list_0, 1);
int x_1 = print_jumper_pts_to_value(my_copy_1_1, 1);
...
//
node * my_copy_2_1 = array_ptrs_to_each_element_in_linked_list(linked_list_2, 2);
int x_2_1 = print_jumper_pts_to_value(my_copy_2_1, 2);
//
...
//
node * my_copy_3_1 = array_ptrs_to_each_element_in_linked_list(linked_list_3, 3);
int x_3_ = print_jumper_pts_to_value(my_copy_3_1, 3);
//
...
TEST_CASE("Testing array_ptrs_to_each_element_in_linked_list") {
  ...
  CHECK( array[0].number == -1 );

  CHECK( array_of_elts[0].number == -1 );
